...
END
    `);
        ...
        // Fix 3: And while we are at it, why not make sp_Tareas_ObtenerPorUsuario do the same check? 
        // Wait, let's just make sure the SP is correct
        console.log('Successfully updated two stored procedures!');
    } catch (e) {
